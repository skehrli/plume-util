...
public class IdentityArraySet<E extends @UnknownSignedness Object> extends AbstractSet<E> {
  ...
  @Pure
  @Override
  public @NonNegative int size(@NotOwningCollection IdentityArraySet<E> this) {
    return size;
  }
  ...
  @Override
  public boolean add(@NotOwningCollection IdentityArraySet<E> this, @Owning E value) {
  ...
  @Override
  public Iterator<E> iterator(@PolyOwningCollection IdentityArraySet<E> this) {
